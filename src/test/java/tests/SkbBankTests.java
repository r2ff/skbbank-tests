...
public class SkbBankTests extends TestBase {
    ...
    void checkTitleTextTest() {
        ...
        step("Заголовок должен содержать текст 'Частным клиентам: кредит наличными, интернет банк, вклады, " +
                "кредитные карты с cash-back, переводы с карты на карту | СКБ-Банк'", () -> {
            String expectedTitle = "Частным клиентам: кредит наличными, интернет банк, вклады, " +
                    "кредитные карты с cash-back, переводы с карты на карту | СКБ-Банк";
